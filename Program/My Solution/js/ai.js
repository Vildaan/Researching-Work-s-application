...
*/
  ...
  function TakeMinValueForTwoxTwo(pFPositions){//works
    ...
    for(let f = 9; f != 0; f--){
      for(let i = 1; i < 19; i++){
        if(pFPositions[i] <= minNIA[f] && 
          ((i - 1) <= 8)){
          if(pFPositions[i - 1] == pFPositions[i]){//best conditional *works*
            if(pFPositions[result[1]] > pFPositions[i - 1]){
              result[1] = i - 1;
            }
          }
          else if(pFPositions[i] <= minNIA[f]  && 
            pFPositions[i - 1] <= pFPositions[i]){//works 
      ...
      for(let i = 2; i < 19; i++){
        if(pFPositions[i] <= minNIA[f] && 
          ...
          if(pFPositions[i] <= minNIA[f] && 
            ...
            pFPositions[i - 2] == pFPositions[i]){//best conditional *works*
